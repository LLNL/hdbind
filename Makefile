...
CUDA_PATH ?= "/usr/tce/packages/cuda/cuda-10.2.89"
...
# internal flags
NVCCFLAGS   := -O3 -m${TARGET_SIZE} -std=c++14
CCFLAGS     := -std=c++14
LDFLAGS     :=
...
# Object files:
OBJS = $(OBJ_DIR)/main.o $(OBJ_DIR)/kernels.o $(OBJ_DIR)/encoding.o $(OBJ_DIR)/preprocessor.o 
