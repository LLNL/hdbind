...
if __name__ == "__main__":
    ...
    if args.dataset == "dude":
        ...
        dude_root_p = Path("/g/g13/jones289/workspace/hd-cuda-master/datasets/dude/deepchem_feats")
        ...
        for path in dude_root_p.glob("*/ecfp"):
            ...
            writeDataSetForChoirSIM((x_train, y_train), train_p.with_name("train.choir_dat"))
            writeDataSetForChoirSIM((x_test, y_test), test_p.with_name("test.choir_dat"))

    elif args.dataset == "lit-pcba":

        lit_pcba_root_p = Path("/g/g13/jones289/workspace/hd-cuda-master/datasets/lit_pcba/lit_pcba_full_data")
