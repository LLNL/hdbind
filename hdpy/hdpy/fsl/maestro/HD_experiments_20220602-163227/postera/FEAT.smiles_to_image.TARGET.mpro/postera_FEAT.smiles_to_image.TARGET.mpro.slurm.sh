...
#SBATCH --job-name="postera_FEAT.smiles_to_image.TARGET.mpro"
#SBATCH --output="postera_FEAT.smiles_to_image.TARGET.mpro.out"
#SBATCH --error="postera_FEAT.smiles_to_image.TARGET.mpro.err"
