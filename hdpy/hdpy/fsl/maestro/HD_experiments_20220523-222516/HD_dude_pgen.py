...
def get_custom_generator(env, **kwargs):
	...
	target_list = ["ace", "aces", "ada", "aldr", "ampc", "andr", "bace1", "cdk2", 
						"comt", "dyr", "egfr", "esr1", "fa10", "gcr","hivpr", "hivrt", 
						"hmdh", "hs90a", "inha", "kith", "mcr", "mk14", "nram", "parp1", 
						"pde5a", "pgh1", "pgh2", "pnph", "pparg","prgr", "pur2", "pygm", 
						"rxra", "sahh","src","thrb","try1", "vgfr2"]
    ...
    param_space_list = list(
        product(target_list, feat_list)
    ) 
