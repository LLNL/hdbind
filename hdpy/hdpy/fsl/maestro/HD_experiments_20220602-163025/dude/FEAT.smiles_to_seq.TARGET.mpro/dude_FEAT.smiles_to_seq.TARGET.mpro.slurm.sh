...
#SBATCH --job-name="dude_FEAT.smiles_to_seq.TARGET.mpro"
#SBATCH --output="dude_FEAT.smiles_to_seq.TARGET.mpro.out"
#SBATCH --error="dude_FEAT.smiles_to_seq.TARGET.mpro.err"
