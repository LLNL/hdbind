...
python experiment_single_classifier.py --dataset dude --out_csv results/dude/pgh1_mordred_test_results.csv --n_problems 30 --support_path ${DATA_DIR}/train.npy --query_path ${DATA_DIR}/test.npy --kquery -1
