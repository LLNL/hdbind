...
do
	python experiment_full_dataset_dude.py --out-csv $data_path/results.csv --dataset dude --model-list HD --train-path-list $data_path/train.npy --test-path-list $data_path/test.npy --num-epochs $NUM_EPOCHS
